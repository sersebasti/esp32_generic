...
window.addEventListener('DOMContentLoaded', function() {
    // Tutte le dichiarazioni degli elementi DOM
    ...
    // Qui puoi continuare con il resto della logica che dipende da questi elementi
    // updateCalibButtons();
    // ...sposta qui tutto il codice che usa queste variabili...
    // Ad esempio, event listener, funzioni, ecc.
});
