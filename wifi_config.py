...
def write_all(cfg, path="wifi.json"):
...
def configured_networks_no_password(path="wifi.json"):
    """
...
def add_network(ssid, password, priority=None, path="wifi.json"):
    """
...
def delete_network(ssid, path="wifi.json"):
    """
