"""
Pagina HTML minimale per gestire le reti Wi‑Fi (UI lato client).
Compatibile con il comportamento esistente: nessun argomento, ritorna bytes.
"""
...
async function loadCfg(){
    ...
    try{
        ...
        tbody.innerHTML = '<tr><td colspan="'+COLSPAN()+'" class="err">Impossibile leggere configurazione Wi‑Fi</td></tr>';
    }
}
